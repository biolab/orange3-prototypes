...
from Orange.regression.linear import (RidgeRegressionLearner, LinearModel,
                                      ...
                                      PolynomialLearner, PolynomialModel)
...
class OWPolynomialRegression(widget.OWWidget):
    name = "Polynomial Regression"
    description = "Univariate polynomial regression"
    icon = "icons/PolynomialRegression.svg"
