...
from orangecontrib.prototypes.widgets.owpivot import (OWPivot, Pivot,
...
class TestOWPivot(WidgetTest):
    ...
    def test_comboboxes(self):
        ...
        for var in domain.variables + domain.metas:
            ...
            if var.is_continuous:
                ...
                self.assertNotIn(var, controls.row_feature.model())
                self.assertNotIn(var, controls.col_feature.model())
    ...
    def test_selection_click(self):
        ...
        # column in a group
        QTest.mouseClick(view.viewport(), Qt.LeftButton, pos=QPoint(309, 133))
        self.assertSetEqual({(3, 0), (2, 0)}, view.get_selection())

        # column
        QTest.mouseClick(view.viewport(), Qt.LeftButton, pos=QPoint(376, 40))
        ...
        # all
        QTest.mouseClick(view.viewport(), Qt.LeftButton, pos=QPoint(426, 198))
...
class TestPivot(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.table.save("/Users/vesna/orange3/Orange/datasets/test1.tab")
    ...
    @patch("orangecontrib.prototypes.widgets.owpivot.Pivot.Count.func",
           side_effect=Pivot.Count.func)
    @patch("orangecontrib.prototypes.widgets.owpivot.Pivot.Sum.func",
