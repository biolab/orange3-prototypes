...
import Orange.misc
from orangecontrib.prototypes.hierarchicalclusteringplus.distance import distance
...
class OWDistances(OWWidget, ConcurrentWidgetMixin):
    ...
    def on_done(self, result: DistMatrix):
        assert isinstance(result, DistMatrix) or result is None
